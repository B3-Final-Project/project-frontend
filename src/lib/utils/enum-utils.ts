...
export function formatGenderEnum(value: number | string): string {
  ...
  switch(value) {
    ...
    case GenderEnum.NON_BINARY: return 'Non-Binary';
    case GenderEnum.OTHER: return 'Other';
    default: return '';
  }
}
...
export function formatOrientationEnum(value: number | string): string {
  ...
  switch(value) {
    case OrientationEnum.STRAIGHT: return 'Straight';
    case OrientationEnum.GAY: return 'Gay';
    case OrientationEnum.LESBIAN: return 'Lesbian';
    case OrientationEnum.BISEXUAL: return 'Bisexual';
    case OrientationEnum.PANSEXUAL: return 'Pansexual';
    case OrientationEnum.ASEXUAL: return 'Asexual';
    case OrientationEnum.OTHER: return 'Other';
    default: return '';
  }
}
...
export function formatRelationshipTypeEnum(value: number | string): string {
  ...
  switch(value) {
    case RelationshipTypeEnum.CASUAL: return 'Casual Dating';
    case RelationshipTypeEnum.LONG_TERM: return 'Long-Term Relationship';
...
export function formatSmokingEnum(value: number | string): string {
  ...
  switch(value) {
    case SmokingEnum.NEVER: return 'Never';
    case SmokingEnum.OCCASIONALLY: return 'Occasionally';
    case SmokingEnum.REGULARLY: return 'Regularly';
    case SmokingEnum.TRYING_TO_QUIT: return 'Trying to Quit';
    case SmokingEnum.UNKNOWN: return 'Prefer Not to Say';
    default: return '';
  }
}
...
export function formatDrinkingEnum(value: number | string): string {
  ...
  switch(value) {
    case DrinkingEnum.NEVER: return 'Never';
    case DrinkingEnum.SOCIALLY: return 'Socially';
    case DrinkingEnum.REGULARLY: return 'Regularly';
    default: return '';
  }
}
...
export function formatReligionEnum(value: number | string): string {
  ...
  switch(value) {
    case ReligionEnum.ATHEIST: return 'Atheist';
    case ReligionEnum.AGNOSTIC: return 'Agnostic';
    case ReligionEnum.BUDDHIST: return 'Buddhist';
    case ReligionEnum.CHRISTIAN: return 'Christian';
    case ReligionEnum.HINDU: return 'Hindu';
    case ReligionEnum.JEWISH: return 'Jewish';
    case ReligionEnum.MUSLIM: return 'Muslim';
    case ReligionEnum.SPIRITUAL: return 'Spiritual';
    case ReligionEnum.OTHER: return 'Other';
    case ReligionEnum.PREFER_NOT_TO_SAY: return 'Prefer Not to Say';
    default: return '';
  }
}
...
export function formatPoliticsEnum(value: number | string): string {
  ...
  switch(value) {
    case PoliticsEnum.LIBERAL: return 'Liberal';
    case PoliticsEnum.MODERATE: return 'Moderate';
    case PoliticsEnum.CONSERVATIVE: return 'Conservative';
    case PoliticsEnum.NOT_POLITICAL: return 'Not Political';
    case PoliticsEnum.OTHER: return 'Other';
    case PoliticsEnum.PREFER_NOT_TO_SAY: return 'Prefer Not to Say';
    default: return '';
  }
}
...
export function formatZodiacEnum(value: number | string): string {
  ...
  switch(value) {
    case ZodiacEnum.ARIES: return 'Aries';
    case ZodiacEnum.TAURUS: return 'Taurus';
    case ZodiacEnum.GEMINI: return 'Gemini';
    case ZodiacEnum.CANCER: return 'Cancer';
    case ZodiacEnum.LEO: return 'Leo';
    case ZodiacEnum.VIRGO: return 'Virgo';
    case ZodiacEnum.LIBRA: return 'Libra';
    case ZodiacEnum.SCORPIO: return 'Scorpio';
    case ZodiacEnum.SAGITTARIUS: return 'Sagittarius';
    case ZodiacEnum.CAPRICORN: return 'Capricorn';
    case ZodiacEnum.AQUARIUS: return 'Aquarius';
    case ZodiacEnum.PISCES: return 'Pisces';
    case ZodiacEnum.DONT_BELIEVE: return 'Don\'t Believe in Zodiac Signs';
    default: return '';
  }
}

export function formatEnumByField(value: number | string, fieldName: string): string {
  switch (fieldName) {
    case 'gender':
