...
export function getBoosterIcon(type: RelationshipTypeEnum, packName: string) {
...
export function getBoosterBackgroundColor(type: RelationshipTypeEnum, packName: string): string {
    if (packName.toLowerCase().includes('water')) {
        return 'bg-blue-500';
    } else if (packName.toLowerCase().includes('grass')) {
