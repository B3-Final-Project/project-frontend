...
export function GenderDistributionChart() {
  ...
  const genderData = [
    {
      name: "Male",
      value: comprehensiveStats.demographics.malePercentage,
      color: "#0088FE",
    },
    {
      name: "Female",
      value: comprehensiveStats.demographics.femalePercentage,
      color: "#FF8042",
    },
    {
      name: "Non-Binary",
      value: comprehensiveStats.demographics.nonBinaryPercentage,
      color: "#00C49F",
    },
    {
      name: "Other",
      value: comprehensiveStats.demographics.otherPercentage,
      color: "#FFBB28",
    },
  ];
