  ...
  const metricCards = [
    {
      ...
      subtitle: comprehensiveStats.activity
        ? `+${comprehensiveStats.activity.newUsersToday} today`
        : undefined,
      icon: Users,
    },
    {
      ...
      subtitle: comprehensiveStats.engagement
        ? `${formatPercentage(comprehensiveStats.engagement.matchRate)} match rate`
        : undefined,
      icon: Heart,
    },
    {
      title: "Engagement",
      value: comprehensiveStats.engagement?.averageLikesPerUser
        ? comprehensiveStats.engagement.averageLikesPerUser.toFixed(1)
        : "0",
